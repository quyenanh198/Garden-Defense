...
/// rows/cols theo chế độ chơi (campaign 5×9, Endless desktop 10×20).
class GridBoard extends PositionComponent with TapCallbacks {
  GridBoard({required this.rows, required this.cols})
  ...
  double get cellW => gridW / cols;
  double get cellH => gridH / rows;
