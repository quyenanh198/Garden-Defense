...
void main() {
  test('hp bar shows only when the plant has taken damage', () {
    ...
    expect(PlantView(wallnut, SpriteRegistry()).showsHpBar, isFalse);
    wallnut.hp -= 1;
    expect(PlantView(wallnut, SpriteRegistry()).showsHpBar, isTrue);
    ...
    expect(PlantView(pea, SpriteRegistry()).showsHpBar, isFalse);
    pea.hp -= 1;
    expect(PlantView(pea, SpriteRegistry()).showsHpBar, isTrue);
  });
}
